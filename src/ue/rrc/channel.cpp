...
void UeRrcTask::sendRrcMessage(ASN_RRC_BCCH_BCH_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::BCCH_BCH, std::move(pdu)));
}
...
void UeRrcTask::sendRrcMessage(ASN_RRC_BCCH_DL_SCH_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::BCCH_DL_SCH, std::move(pdu)));
}
...
void UeRrcTask::sendRrcMessage(ASN_RRC_DL_CCCH_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::DL_CCCH, std::move(pdu)));
}
...
void UeRrcTask::sendRrcMessage(ASN_RRC_DL_DCCH_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::DL_DCCH, std::move(pdu)));
}
...
void UeRrcTask::sendRrcMessage(ASN_RRC_PCCH_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::PCCH, std::move(pdu)));
}
...
void UeRrcTask::sendRrcMessage(ASN_RRC_UL_CCCH_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::UL_CCCH, std::move(pdu)));
}
...
void UeRrcTask::sendRrcMessage(ASN_RRC_UL_CCCH1_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::UL_CCCH1, std::move(pdu)));
}
...
void UeRrcTask::sendRrcMessage(ASN_RRC_UL_DCCH_Message *msg)
{
    ...
    m_base->mrTask->push(new NwUeUplinkRrc(rrc::RrcChannel::UL_DCCH, std::move(pdu)));
}
